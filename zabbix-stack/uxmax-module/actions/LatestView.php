...
use API, CArrayHelper, CRoleHelper, CSettingsHelper, CControllerLatestView;
use Modules\uxMAX\Module;

/**
 * Extends the stock latest.view controller. When the uxMAX preference
 * "latestshowdisabled" is enabled AND the user has ticked the "Show disabled
 * items" checkbox in the filter (filter_show_disabled=1 in the request), the
 * API item query is widened to include ITEM_STATUS_DISABLED items as well.
 * Otherwise behaviour is identical to the stock controller.
 */
class LatestView extends CControllerLatestView {
